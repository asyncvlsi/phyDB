...
struct RectSignalLayer {
 ...
 public:
  RectSignalLayer(std::string &signal_name, std::string &layer_name, int llx,
...
struct SpecialMacroRectLayout {
 ...
 public:
  explicit SpecialMacroRectLayout(Macro *macro_ptr, int llx, int lly, int urx,
                                  int ury);
  void SetBoundingBox(int llx, int lly, int urx, int ury);
  void AddRectSignalLayer(std::string &signal_name, std::string &layer_name,
